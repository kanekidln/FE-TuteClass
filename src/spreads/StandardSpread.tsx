...
import type { InsightCard, SpreadNoteCard, StandardSpreadData } from "../features/notebook";
    ...
    <>
      ...
      <div className="flex gap-8 flex-1">
        <div className="w-3/4 flex flex-col gap-6">
          <div className="schedule-panel rounded-xl p-4 border border-orange-100 shadow-sm">
            ...
            <p className="text-sm italic text-gray-500 mb-5">{data.panelSubtitle}</p>
            <div className="standard-card-grid">
              {data.cards.map((card) => (
                <PaperCard className={`rounded-2xl border p-4 shadow-sm ${toneClasses[card.tone]}`} key={card.title}>
            ...
            <div className="mt-5 rounded-2xl border border-blue-100 bg-white/80 px-4 py-4">
