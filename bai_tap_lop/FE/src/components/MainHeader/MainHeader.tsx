...
export function MainHeader({ activeWorkspace = "student", onWorkspaceChange }: MainHeaderProps) {
  return (
    <>
        ...
        <div className="app-header__surface">
          <div className="app-header__left">
            ...
            <nav className="app-header__nav" aria-label="Main navigation">
              <a className="app-header__nav-link" href="#student">
              ...
              <a className="app-header__nav-link is-active" href={`#${activeWorkspace}`}>
                <svg className="app-header__nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a className="app-header__nav-link" href={`#${activeWorkspace}`}>
                <svg className="app-header__nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
