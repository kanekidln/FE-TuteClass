import type { ScheduleEvent } from "../../../features/notebook";
  ...
  return (
    <div className="schedule-panel rounded-xl p-4 border border-orange-100 shadow-sm">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-2 bg-white px-3 py-1 rounded-lg border border-gray-200 text-xs font-bold text-gray-600">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="timetable-scroll-area relative border-t border-gray-100">
        <div className="relative min-h-[1152px]">
          ...
          {events.map((event, index) => (
            <div
              className={`absolute w-[11%] h-[72px] border rounded p-1 text-[8px] shadow-sm z-10 ${event.className}`}
